...
import handleStoryPrompt from '../functions/story'

import { rank } from "@/lib/linkedin-algorithm";
import { Toaster, toast } from "react-hot-toast";
import LoadingDots from "@/components/LoadingDots";
import DropDown, { VibeType } from "@/components/StoryDropDown";
...
export default function Stories() {
  ...
  const [vibe, setVibe] = useState<VibeType>("Adventure");
  ...
  const optimizePost = async (e: any) => {
    ...
    setOptimizedPost("");
    setLoading(true);
    const prompt = handleStoryPrompt(vibe, post);
