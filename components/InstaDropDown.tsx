...
export type VibeType = "One-liner caption" | "Post Caption" | "Inspirational Quote" | "Question" | "Music Recommender";
...
let vibes: VibeType[] = ["One-liner caption", "Post Caption", "Inspirational Quote", "Question", "Music Recommender"];
